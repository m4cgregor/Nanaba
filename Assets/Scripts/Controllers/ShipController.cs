...
public class ShipController : MonoBehaviour
{
    ...
    public void SetDestinationPort(PortController newDestinationPort)
    {
       
        
        Debug.Log("Setting Destination Port to: " + (newDestinationPort != null ? newDestinationPort.name : "None"));   

        shipData.destinationPort = newDestinationPort;
